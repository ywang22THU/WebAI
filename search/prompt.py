...
def get_website_category_prompt() -> str:
    ...
    prompt += "The url is the current page url, and the picture is the screenshot of the current page. \n\n"
    prompt += "Your task is: \n"
    prompt += "Judge which kind of things the user is searching. \n\n"
    ...
    prompt += "Notes: \n"
    prompt += "1. Only provide the category, not extra explanations. \n\n"
    return prompt